...
namespace Service {
    ...
    public interface IFeed1 {
       ...
       [WebGet(UriTemplate = "students/{studentId}/notes", BodyStyle = WebMessageBodyStyle.Bare)]
           // [WebGet(UriTemplate = "students/{studentId}/notes", BodyStyle = WebMessageBodyStyle.Bare, ResponseFormat = WebMessageFormat.Json)]
   //     SyndicationFeedFormatter GetStudentNotes(string studentId);
         List<Note> GetStudentNotes(string studentId);
    }
}
