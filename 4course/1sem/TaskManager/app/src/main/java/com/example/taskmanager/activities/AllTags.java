    ...
    private void showNewTagDialog(){
        ...
        addNewtag.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isTagEmpty){
                    tagTitle.setError("Empty tag name!");
                }else if(tagExists){
                    tagTitle.setError("Tag already exists!");
                }else {
